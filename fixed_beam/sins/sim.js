...
function display()
{
    ...
    var mass = parseInt(lumpmass) + ((density * area * parseInt(length))*0.375);
    var k = (192 * e * i) / (Math.pow(parseInt(length),3));
    var c = 2 * Math.sqrt((mass/1000)*k) * zeta;
    var omegan = Math.sqrt((k*1000)/mass);
    var omegad = omegan * Math.sqrt(1-Math.pow(zeta,2));
    $("#commentboxright").html("Mass = "+mass.toFixed(2)+" Kg, K = "+k.toFixed(2)+" N/mm, c = "+c.toFixed(2)+" Ns/mm, &omega;<sub></sub> = "+omegan.toFixed(2)+" rad/sec, &omega;<sub>d</sub> = "+omegad.toFixed(2)+" rad/sec.");
    ...
    window.requestAnimFrame = (function(callback) {
      ...
      function drawRectangle(myRectangle, context) {
        ...
        context.beginPath();
        context.rect(30,120, 20, 250);
        context.rect((myRectangle.x*2)+50,120, 20, 250);
        context.closePath();
        context.fill();
        context.fillStyle = "blue";
        context.beginPath();
        context.moveTo(50, 235);
        context.quadraticCurveTo(myRectangle.x+50,myRectangle.y-10,(myRectangle.x*2)+50,235);
        context.lineTo((myRectangle.x*2)+50,255);
        context.quadraticCurveTo(myRectangle.x+50,myRectangle.y+10,50,255);
        context.closePath();
        context.fill();
        var temp1x = (myRectangle.x+50 + 50) / 2;
        var temp1y = (myRectangle.y + 245) / 2;
        var temp2x = (((myRectangle.x * 2)+50) + (myRectangle.x + 50)) / 2;
        var temp2y = (myRectangle.y + 245) / 2;
