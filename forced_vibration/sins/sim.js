...
{   
    ...
    var force = $("#force").val();
    var forcefrequency = $("#forcefrequency").val();
    var omegan = Math.sqrt((stiffness*1000)/mass);
    var eta = forcefrequency / omegan;
    ...
    updategraph(forcefrequency,force,zeta,omegan,stiffness);
    var param = 1;
    ...
    window.requestAnimFrame = (function(callback) {
      ...
      function animate(myRectangle, canvas, context,startTime) {  
        ...
        //alert(animpoints[i]+"is"+param);
        //animpoints[i] = animpoints[i] / param;
        myRectangle.y = ((animpoints[i]*100)+100);
...
$("#forcefrequency").change(function() {
    display();
});
$("#graphbutton").click(function(){
    ...
    if(temp == "sins/bluefwddulls.png")
    {
        ...
        $("#magnificationscreen").show();
        $("#phaseanglescreen").show();
        $("#displacementscreen").hide();
        $("#appliedforcescreen").hide();
        ...
        $("#forcefrequency").prop('disabled', true);
    }
    else
    {
        ...
        $("#forcefrequency").prop('disabled', false);
